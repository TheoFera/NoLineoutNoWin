...
export const translations: Record<TranslationKey, Record<Language, string>> = {
  ...
  "squad.recruit": { fr: "+ Recruter", en: "+ Recruit" },
  "squad.emptyBench": { fr: "Aucun remplaçant. Recrute pour étoffer ton groupe !", en: "No substitutes. Recruit to grow your squad!" },
  "squad.selectHint": { fr: "Sélectionne un joueur pour voir ses statistiques ou préparer un échange.", en: "Select a player to see their stats or prepare a swap." },
  "squad.chooseReserve": { fr: "Choisis un remplaçant sur le banc.", en: "Choose a substitute on the bench." },
  "squad.chooseStarter": { fr: "Choisis le titulaire à remplacer.", en: "Choose the starter to replace." },
  "squad.roleMismatch": { fr: "Un talonneur remplace un talonneur.", en: "A hooker replaces a hooker." },
  "squad.swap": { fr: "Échanger", en: "Swap" },
  "squad.back": { fr: "‹ Équipe", en: "‹ Squad" },
  "recruit.title": { fr: "Tourne la roue pour tenter de recruter de meilleurs joueurs", en: "Spin the wheel for a chance to recruit better players" },
  "recruit.band.0": { fr: "Niveau N", en: "Level N" },
  "recruit.band.1": { fr: "Niveau N+1", en: "Level N+1" },
  "recruit.band.2": { fr: "Niveau N+2", en: "Level N+2" },
  "squad.returnManagement": { fr: "Revenir à la gestion de l’équipe", en: "Return to squad management" },
  "squad.managementTitle": { fr: "Gestion de l’équipe", en: "Team management" },
  "squad.level": { fr: "Niveau", en: "Level" },
  "squad.removePlayer": { fr: "Retirer de l’équipe", en: "Remove from team" },
  "squad.dropToRemove": { fr: "Dépose le joueur ici", en: "Drop the player here" },
  "squad.removeError.minimumPlayers": { fr: "L’équipe doit garder au moins 8 joueurs.", en: "Keep at least 8 players on the team." },
  "squad.removeError.lastHooker": { fr: "L’équipe doit garder au moins un talonneur.", en: "Keep at least one hooker on the team." },
  "squad.removeError.minimumFieldPlayers": { fr: "Il faut garder 7 joueurs de champ pour la touche.", en: "Keep 7 field players for the lineout." },
  "recruit.profile.hooker": { fr: "Talon", en: "Hooker" },
  "recruit.profile.prop": { fr: "Pilier", en: "Prop" },
  "recruit.profile.secondRow": { fr: "2ème ligne", en: "Second row" },
  "recruit.profile.backRow": { fr: "3ème ligne", en: "Back row" },
  "recruit.spin": { fr: "▶ Lancer la roue", en: "▶ Spin the wheel" },
  "recruit.result": { fr: "Un nouveau joueur se propose de rejoindre votre équipe", en: "A new player offers to join your team" },
  "recruit.playerName": { fr: "Nom du joueur", en: "Player name" },
  "recruit.field": { fr: "Joueur de champ", en: "Field player" },
  "recruit.keep": { fr: "Intégrer à l’équipe", en: "Add to the team" },
  "recruit.decline": { fr: "Refuser ce joueur", en: "Decline this player" },
  ...
  "match.ballPosition": { fr: "Le ballon est à {meters} m de l’en-but adverse", en: "The ball is {meters} m from the opposition in-goal area" },
  ...
  "lineout.v3.combinationsTitle": { fr: "Combinaisons", en: "Combinations" },
  "lineout.v3.offensiveCombinations": { fr: "Offensives", en: "Attacking" },
  "lineout.v3.defensiveCombinations": { fr: "Défensives", en: "Defensive" },
  "lineout.overlay.offensiveTab": { fr: "Touche offensive", en: "Attacking lineout" },
  "lineout.overlay.defensiveTab": { fr: "Touche défensive", en: "Defensive lineout" },
  "lineout.overlay.defensiveSize": { fr: "{size} joueurs annoncés", en: "{size} players announced" },
  ...
  "lineout.v3.defensiveFormationHint": { fr: "Prépare ton placement défensif selon le nombre de joueurs annoncés par l'adversaire dans la touche.", en: "Prepare the starting setup for every lineout size." },
