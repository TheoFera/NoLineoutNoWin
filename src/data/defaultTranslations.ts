...
export const translations: Record<TranslationKey, Record<Language, string>> = {
  ...
  "teamCreation.headStyle": { fr: "Accessoires (gabarit standard)", en: "Accessories (standard body)" },
  "teamCreation.headStyle.default": { fr: "Aucun", en: "None" },
  "teamCreation.headStyle.helmet": { fr: "Casque", en: "Headguard" },
  "teamCreation.headStyle.bald": { fr: "Chauve", en: "Bald" },
