...
export const translations: Record<TranslationKey, Record<Language, string>> = {
  ...
  "recruit.title": { fr: "Roue de recrutement", en: "Recruitment wheel" },
  "recruit.hint": { fr: "Tourne gratuitement la roue pour découvrir un nouveau joueur !", en: "Spin the wheel for free to discover a new player!" },
  "recruit.band.0": { fr: "Niveau N", en: "Level N" },
  "recruit.band.1": { fr: "Niveau N+1", en: "Level N+1" },
  "recruit.band.2": { fr: "Niveau N+2", en: "Level N+2" },
  "squad.returnManagement": { fr: "Revenir à la gestion d’équipe", en: "Return to squad management" },
